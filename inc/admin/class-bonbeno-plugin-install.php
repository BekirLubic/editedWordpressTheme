...
if ( ! class_exists( 'bonbeno_Plugin_Install' ) ) :
	/**
	 * The bonbeno plugin install class
	 */
	class bonbeno_Plugin_Install {
		...
		public function plugin_install_scripts( $hook_suffix ) {
			...
			wp_enqueue_script( 'bonbeno-plugin-install', get_template_directory_uri() . '/assets/js/admin/plugin-install' . $suffix . '.js', array( 'jquery', 'updates' ), $bonbeno_version, 'all' );

			wp_enqueue_style( 'bonbeno-plugin-install', get_template_directory_uri() . '/assets/css/admin/plugin-install.css', array(), $bonbeno_version, 'all' );
		}
			...
			if ( current_user_can( 'install_plugins' ) && current_user_can( 'activate_plugins' ) ) {
				if ( is_plugin_active( $plugin_slug . '/' . $plugin_file ) ) {
					...
					$button = array(
						...
						'url'     => '#',
						'classes' => array( 'bonbeno-button', 'disabled' ),
					);
					...
					$button = array(
						...
						'url'     => $url,
						'classes' => array( 'bonbeno-button', 'activate-now' ),
					);
					...
					$button = array(
						...
						'url'     => $url,
						'classes' => array( 'bonbeno-button', 'sf-install-now', 'install-now', 'install-' . $plugin_slug ),
					);
...
return new bonbeno_Plugin_Install();
